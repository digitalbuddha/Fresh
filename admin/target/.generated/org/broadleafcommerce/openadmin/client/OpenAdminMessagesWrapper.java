...
public class OpenAdminMessagesWrapper implements org.broadleafcommerce.openadmin.client.i18nConstants {
  private java.util.List<String> supportedLocales = new java.util.ArrayList<String>();
  public OpenAdminMessagesWrapper() {
  ...
  if (localeName == null){
  i18nClient.onSuccess(new org.broadleafcommerce.openadmin.client.OpenAdminMessages_default().getAlli18nProperties());
return;
  }
...
return;
  ...
  i18nClient.onUnavailable(new RuntimeException("Unable to find a localized file for org.broadleafcommerce.openadmin.client.OpenAdminMessagesWrapper"));
  }
}
