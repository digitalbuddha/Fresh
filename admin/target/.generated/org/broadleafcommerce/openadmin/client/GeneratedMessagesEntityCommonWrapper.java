...
public class GeneratedMessagesEntityCommonWrapper implements org.broadleafcommerce.openadmin.client.i18nConstants {
  private java.util.List<String> supportedLocales = new java.util.ArrayList<String>();
  public GeneratedMessagesEntityCommonWrapper() {
  ...
  if (localeName == null){
  i18nClient.onSuccess(new org.broadleafcommerce.openadmin.client.GeneratedMessagesEntityCommon_default().getAlli18nProperties());
return;
  }
...
return;
  ...
  i18nClient.onUnavailable(new RuntimeException("Unable to find a localized file for org.broadleafcommerce.openadmin.client.GeneratedMessagesEntityCommonWrapper"));
  }
}
