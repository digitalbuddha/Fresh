...
public class SandBoxMessagesWrapper implements org.broadleafcommerce.openadmin.client.i18nConstants {
  private java.util.List<String> supportedLocales = new java.util.ArrayList<String>();
  public SandBoxMessagesWrapper() {
  ...
  if (localeName == null){
  i18nClient.onSuccess(new org.broadleafcommerce.cms.admin.client.SandBoxMessages_default().getAlli18nProperties());
return;
  }
...
return;
  ...
  i18nClient.onUnavailable(new RuntimeException("Unable to find a localized file for org.broadleafcommerce.cms.admin.client.SandBoxMessagesWrapper"));
  }
}
