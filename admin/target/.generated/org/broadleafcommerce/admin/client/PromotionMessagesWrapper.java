...
public class PromotionMessagesWrapper implements org.broadleafcommerce.openadmin.client.i18nConstants {
  private java.util.List<String> supportedLocales = new java.util.ArrayList<String>();
  public PromotionMessagesWrapper() {
  ...
  if (localeName == null){
  i18nClient.onSuccess(new org.broadleafcommerce.admin.client.PromotionMessages_default().getAlli18nProperties());
return;
  }
...
return;
  ...
  i18nClient.onUnavailable(new RuntimeException("Unable to find a localized file for org.broadleafcommerce.admin.client.PromotionMessagesWrapper"));
  }
}
